...
const ProjectSidebar = ({
  ...
  return (
    <>
      ...
      {isFullscreen && (
        <div className="fixed inset-0 z-[60] bg-black/95 flex flex-col">
          ...
          >
            <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
              <foreignObject x="-8.3" y="-8.3" width="51.6" height="51.6">
                <div xmlns="http://www.w3.org/1999/xhtml" style={{backdropFilter:'blur(4.15px)', clipPath:'url(#bgblur_fullscreen_left_clip_path)', height:'100%', width:'100%'}}></div>
              </foreignObject>
              <circle cx="17.5" cy="17.5" r="17.5" fill="white" fillOpacity="0.32"/>
              ...
              <defs>
                <clipPath id="bgblur_fullscreen_left_clip_path" transform="translate(8.3 8.3)">
          ...
          <button
            ...
            className="absolute right-4 top-1/2 transform -translate-y-1/2 z-10 transition-all duration-200 hover:scale-110"
          >
            <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ transform: 'rotate(180deg)' }}>
              <foreignObject x="-8.3" y="-8.3" width="51.6" height="51.6">
                <div xmlns="http://www.w3.org/1999/xhtml" style={{backdropFilter:'blur(4.15px)', clipPath:'url(#bgblur_fullscreen_right_clip_path)', height:'100%', width:'100%'}}></div>
              </foreignObject>
              <circle cx="17.5" cy="17.5" r="17.5" fill="white" fillOpacity="0.32"/>
              <path d="M20 11C20 11 14 15.4189 14 17C14 18.5812 20 23 20 23" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <defs>
                <clipPath id="bgblur_fullscreen_right_clip_path" transform="translate(8.3 8.3)">
                  <circle cx="17.5" cy="17.5" r="17.5"/>
                </clipPath>
              </defs>
            </svg>
          ...
          {/* Fullscreen dots */}
          <div 
            className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex justify-center gap-[10px]" 
            style={{ 
              width: 'calc(100% - 4rem)',
              maxWidth: '800px'
            }}
          >
            {images.map((_, index) => {
              ...
              const dotWidth = Math.min(187, (800 - (images.length - 1) * 10) / images.length)
      ...
      {/* Bottom Sidebar */}
      <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-[calc(100%-2rem)] max-w-[1920px] min-w-[995px] h-[75vh] bg-white/95 dark:bg-gray-900/95 shadow-xl z-50 overflow-y-auto rounded-t-2xl backdrop-blur-md shadow-lg">
        {/* Header */}
                  ...
                  {totalPages > 1 && thumbnailImages.length > 0 && (
                    <div className="absolute bottom-2 right-2 flex gap-1">
                      ...
                      >
                        <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <foreignObject x="-8.3" y="-8.3" width="51.6" height="51.6">
                            <div xmlns="http://www.w3.org/1999/xhtml" style={{backdropFilter:'blur(4.15px)', clipPath:'url(#bgblur_left_clip_path)', height:'100%', width:'100%'}}></div>
                          </foreignObject>
                      ...
                      >
                        <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ transform: 'rotate(180deg)' }}>
                          <foreignObject x="-8.3" y="-8.3" width="51.6" height="51.6">
                            <div xmlns="http://www.w3.org/1999/xhtml" style={{backdropFilter:'blur(4.15px)', clipPath:'url(#bgblur_right_clip_path)', height:'100%', width:'100%'}}></div>
                          </foreignObject>
                          <circle data-figma-bg-blur-radius="8.3" cx="17.5" cy="17.5" r="17.5" fill="white" fillOpacity="0.32"/>
                          <path d="M20 11C20 11 14 15.4189 14 17C14 18.5812 20 23 20 23" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                          <defs>
                ...
                <>
                  ...
                  >
                    {Array.from({ length: totalPages }, (_, index) => {
                      ...
                      const totalWidth = totalPages * 187 + (totalPages - 1) * 10 // largura total + gaps
                      const dotWidth = Math.min(187, (window.innerWidth - (totalPages - 1) * 10) / totalPages)
